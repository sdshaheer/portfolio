...
export const projectsData = [
    {
        id: 1,
        name: 'Roojh Health Ecosystem (PMS, Admin Dashboard)',
        role: 'Full-Time',
        description: 'Designed and developed a comprehensive healthcare management system with a secure OTP-based onboarding process, allowing patients to log in, upload medical records, and maintain a health history. Built an interactive doctor dashboard for managing patient data, prescribing medicines, and sending daily reports. Additionally, implemented an admin dashboard for managing doctor and patient access. Developed a Notification Management System to send automated messages with images and documents based on patient criteria such as age, diseases, and medical history.',
        tools: ['Express', 'Node JS', 'React', 'Redux', 'Firebase', 'MongoDB', 'Tailwind CSS', 'cronJob', 'Material UI'],
        images: [],
        isHosted: false,
        hostedLink: ''
    },
    {
        id: 2,
        name: 'All India Institute of Ayurveda (Token management system) aiia.roojh.com',
        role: 'Full-Time',
        description: 'Designed and implemented a comprehensive Token Management System for the All India Institute of Ayurveda, including the Token Management Module, Registration Module, and integration with ABDM M1 (Ayushman Bharat Digital Mission). ',
        tools: ['Express', 'Node JS', 'React', 'Redux', 'MongoDB', 'Tailwind CSS', 'Material UI'],
        images: [],
        isHosted: false,
        hostedLink: ''
    },
